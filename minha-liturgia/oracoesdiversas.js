...
const ORACOES_DIVERSAS = [
  {
    ...
    audioId: 'pela-saude-de-quem-esta-doente',
  ...
  },
  {
    ...
    audioId: 'de-protecao-contra-todo-mal',
  ...
  },
  {
    ...
    audioId: 'pela-cura-das-feridas-interiores',
  ...
  },
  {
    ...
    audioId: 'por-trabalho-e-sustento',
  ...
  },
  {
    ...
    audioId: 'pelas-financas-da-familia',
  ...
  },
  {
    ...
    audioId: 'pela-bencao-da-familia',
  ...
  },
  {
    ...
    audioId: 'de-consagracao-da-casa',
  ...
  },
  {
    ...
    audioId: 'de-consagracao-da-familia-a-jesus-e-maria',
  ...
  },
  {
    ...
    audioId: 'pela-cura-da-historia-da-familia',
  ...
  },
  {
    ...
    audioId: 'oracao-a-sao-miguel-arcanjo',
  ...
  },
  {
    ...
    audioId: 'pequeno-exorcismo-de-santo-antonio',
  ...
  },
  {
    ...
    audioId: 'a-santo-antonio-contra-o-mal',
  ...
  },
  {
    ...
    audioId: 'consagracao-diaria-a-nossa-senhora',
  ...
  },
  {
    ...
    audioId: 'consagracao-ao-sagrado-coracao-de-jesus',
  ...
  },
  {
    ...
    audioId: 'oracao-de-sao-francisco-de-assis',
  ...
  },
  {
    ...
    audioId: 'oracao-de-libertacao-de-sao-patricio',
  ...
  },
  {
    ...
    audioId: 'oracao-de-sao-joao-paulo-ii-pelas-familias',
  ...
  },
  {
    ...
    audioId: 'ladainha-de-sao-miguel-arcanjo',
  ...
  },
  {
    ...
    audioId: 'consagracao-a-sao-miguel-arcanjo',
...
let oracaoDiversaAtual = null;

// Áudio gravado pela própria pessoa da paróquia/família, uma oração de cada
// vez. Se audio/oracoesdiversas/<audioId>.mp3 existir, toca ele; senão, cai
// automaticamente pra voz do aparelho — sem precisar mudar código nenhum
// conforme as gravações forem chegando.
function oracaoDiversaAudioUrl(audioId) {
  return audioId ? `audio/oracoesdiversas/${audioId}.mp3` : null;
}
...
function initOracoesDiversas() {
  ...
  oel('narrateOracaoDiversaBtn').addEventListener('click', () => {
    ...
    const btn = oel('narrateOracaoDiversaBtn');
    const getFallbackText = () => `${oel('oracaoDiversaTitulo').textContent}. ${oel('oracaoDiversaTexto').textContent}`;
    const audioUrl = oracaoDiversaAtual ? oracaoDiversaAudioUrl(oracaoDiversaAtual.audioId) : null;
    if (audioUrl) window.MinhaLiturgiaNarration.playAudio(btn, audioUrl, getFallbackText);
    else window.MinhaLiturgiaNarration.toggle(btn, getFallbackText);
  });
}
